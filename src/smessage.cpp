...
// Copyright (c) 2015 The PayPeer developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("paypeer-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("paypeer-smsg-pow"); // Make this thread recognisable
