...
const string strMessageMagic = "PayPeer Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees, uint256 prevHash)
{
    ...
    int rand = generateMTRandom(seed, 450);
                                                                                   
	if (nHeight <= 0)
        nSubsidy = 0;
	else if (nHeight <= 10)
        nSubsidy = 5000000 * COIN;	// Investors
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PayPeer", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "PAYPEER started 17.02.2016";
        CTransaction txNew;
        txNew.nTime = 1455680000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1455680000;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 53780 : 53780;
...
//        assert(block.hashMerkleRoot == uint256("0xeb42ae0324ea968b5cdcd959104fc3b1cd93c45e25ba5be25b5e55deaf21254c"));
        assert(block.hashMerkleRoot == uint256("0x70a59e256ad314681ed4a5936b64f00486a12e3cf3250cb8e0104655ca38078a"));
    ...
    string strPubKey = "047fe5a9d3732db22995178f767d8c428fad5ed4f9d8a5e6fd83f3b27ff747822fa2af30b9efd0a70a9f18b31742b12ff70e8d4390c0838f639de6d11f3dd0ae2a";
...
unsigned char pchMessageStart[4] = { 0x13, 0x02, 0x1b, 0x3c };
