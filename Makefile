#############################################################################
# Makefile for building: PayPeer-qt
# Generated by qmake (3.0) (Qt 5.2.1)
# Project:  PayPeer-qt.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile PayPeer-qt.pro
#############################################################################
...
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lminiupnpc /root/mazecoin/src/leveldb/libleveldb.a /root/mazecoin/src/leveldb/libmemenv.a -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -L/usr/lib/x86_64-linux-gnu -lQt5Widgets -lQt5DBus -lQt5Network -lQt5Gui -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
...
Makefile: PayPeer-qt.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile PayPeer-qt.pro
...
/root/mazecoin/src/leveldb/libleveldb.a: FORCE
	cd /root/mazecoin/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-m64 -pipe -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/mazecoin/build/build.h: FORCE
	cd /root/mazecoin; /bin/sh share/genbuild.sh /root/mazecoin/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/PayPeer-64.png \
